...
class StackLst: virtual public Stack<Data>,
                ...
                // eredita da lista in maniera protetta, poichè l'utente non deve poter usare le
                // funzioni di lista, quindi ciò che era pubblico in lista sarà protetto in stack
...
public:
  ...
  void Pop() override; // List::RemoveFromFront // Override Stack member (must throw std::length_error when empty)
  Data TopNPop() override; // List::FrontNRemove // Override Stack member (must throw std::length_error when empty)
